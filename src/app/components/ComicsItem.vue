<template>
  <div class="w-1/4 px-4 py-5">
    <div class="comics-item relative rounded" :class="{'opacity-0': item.visibility === 'hidden'}">
      <div class="object-cover object-center">
        <img class="img mx-auto cursor-pointer w-full" :src="path" alt="comics-image" />
      </div>
      <h2
        class="title overflow-hidden rounded py-5 font-bold text-md text-center cursor-pointer absolute w-full left-0 bottom-0 bg-gray-600"
      >
